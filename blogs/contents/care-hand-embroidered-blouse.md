...
- Soak for no more than 5–7 minutes  
- Gently squeeze, don’t scrub

---

## 2. Never Wring or Twist the Fabric

Embroidery threads can snap if twisted.  
Instead, place the blouse on a clean towel and press gently to remove excess water.
...
**Drying tip:**  
Lay it flat, don’t hang. Hanging can stretch the neckline and distort embroidery.

---

## 4. Iron with a Protective Layer

Heat can dull or flatten embroidery.  
Always use a pressing cloth (a thin cotton fabric) over the blouse before ironing.

**Use settings:**
- Low heat or silk mode
- No steam directly on embroidery
...
- Place it in a breathable cotton bag or muslin cover
- Add silica gel packets to prevent moisture

---

## 6. Bead & Thread Check Before Wearing

Before a big event, check for:
- loose threads  
- dangling beads  
- open stitches  

A small quick fix now avoids bigger damage later.
...
it doesn’t just last longer…  
it becomes a memory that travels with you.
